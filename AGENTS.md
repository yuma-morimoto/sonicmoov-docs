...
→ 詳細は [`社内/通勤費申請.md`](社内/通勤費申請.md) を参照
...
2. プロジェクトIDを `zac_get_recommended_projects` または `zac_search_projects` で取得する
...
- 事業外（社内勉強会、個人学習、亀の世話など）の作業は、**「2503092 カメ農園復活プロジェクト」** の案件に工数計上する。
- **2026年7月末まで**この運用を継続する。
